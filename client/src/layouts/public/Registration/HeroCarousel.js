...
export default function HeroCarousel() {
  ...
  return (
    <Carousel className="HeroCarousel" showThumbs={false}>
      ...
      <div>
        ...
        <div className="legend">
          <div className="inner">
            <h1>Group Chats</h1>
            <p>
              Each user group is equipped with its own Group Chat - thus
              enabling the members to communicate and collaborate efficiently as
              a team!
            </p>
          </div>
        </div>
